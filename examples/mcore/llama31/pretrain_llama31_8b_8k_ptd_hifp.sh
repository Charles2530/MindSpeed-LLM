...
CUSTOM_QUANT_TYPE=${CUSTOM_QUANT_TYPE:-hif8}
...
CKPT_SAVE_DIR="/afs-c-mtc/gongruihao/deepseek_910b/MindSpeed-LLM/saved_ckpt/llama31_hifp"
...
CKPT_LOAD_DIR="/afs-c-mtc/gongruihao/deepseek_910b/MindSpeed-LLM/saved_ckpt/llama31_hifp"
...
torchrun $DISTRIBUTED_ARGS pretrain_gpt.py \
    ...
    --load ${CKPT_SAVE_DIR} \
    --save ${CKPT_SAVE_DIR} \
    | tee logs/train_llama31_8b_hifp_$(date +"%Y%m%d_%H%M%S").log
