...
# custom_quant_type: 'bf16' = no fake quant, 'mxfp8' = enable (layers.py linear quant; dot_product_attention QKV quant for Llama)
CUSTOM_QUANT_TYPE=${CUSTOM_QUANT_TYPE:-bf16}
